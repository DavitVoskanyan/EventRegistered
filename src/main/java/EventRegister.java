...
public class EventRegister implements EventCommands {
    ...
    private static void addUser() {
        showAllEvents();
        System.out.println("please chose event`s id");
        int eventId = Integer.parseInt(SCANNER.nextLine());
        Event event = eventManager.getById(eventId);
        if (event==null){
            System.out.println("please choose correct ID");
        }else {System.out.println("please input user`s name,surname, email");
    ...
    private static void addEvent() {
        System.out.println("please input event`s name,place, isOnline,eventType(FILM,SPORT, GAME),price,date()");
